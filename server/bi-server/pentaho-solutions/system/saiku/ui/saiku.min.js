...
a.remainingdays+" days remaining. \x3ca href\x3d'http://www.meteorite.bi/saiku-pricing'\x3eBuy licenses online.\x3c/a\x3e\x3c/div\x3e")):$(a.workspace.el).find(".upgrade").append("\x3cdiv\x3e\x3cdiv id\x3d'uphead' class\x3d'upgradeheader'\x3eYou are using Saiku Community Edition, please consider upgrading to \x3ca target\x3d'_blank' href\x3d'http://meteorite.bi'\x3eSaiku Enterprise\x3c/a\x3e, or entering a \x3ca href\x3d'http://meteorite.bi/products/saiku/sponsorship'\x3esponsorship agreement with us\x3c/a\x3e to support development. \x3ca href\x3d'http://meteorite.bi/products/saiku/community'\x3eOr contribute by joining our community and helping other users!\x3c/a\x3e\x3c/div\x3e\x3c/div\x3e");
...
buttons:[{text:"Login",method:"login"},{text:"Upload License",method:"upload_license"}],events:{"click .dialog_footer a":"call","keyup #login_form input":"check","click #eval-login":"show_panel_user","click .clearlink":"clear_login"},initialize:function(a){_.extend(this,a);_.bindAll(this,"adjust");this.options.title=Settings.VERSION;this.bind("open",this.adjust)},adjust:function(){this.$el.parent().find(".ui-dialog-titlebar-close").hide();this.$el.find("#username").focus();this.$el.find(".dialog_footer").find('a[href\x3d"#upload_license"]').hide()},
check:function(a){13===a.which&&this.login()},login:function(){var a=this.$el.find("#username").val(),b=this.$el.find("#password").val();this.$el.dialog("close");this.session.login(a,b,this.$el);return!0},clear_login:function(a){window.open("/clear.html","_blank")},setMessage:function(a){this.$el.find(".dialog_body").html(this.message)},setError:function(a){this.$el.find(".dialog_response").html(a);"license expired"===a&&this.$el.find(".dialog_footer").find('a[href\x3d"#upload_license"]').show();
this.$el.find(".clearlink").unbind()},show_panel_user:function(a){a.preventDefault();$(a.currentTarget).next().slideToggle("fast")},upload_license:function(a){a.preventDefault();window.open(window.location.href+"upload.html","_self")}}),AboutModal=Modal.extend({type:"info",events:{"click a":"close"},message:Settings.VERSION+'\x3cbr\x3e\x3ca href\x3d"http://saiku.meteorite.bi" target\x3d"_blank"\x3ehttp://saiku.meteorite.bi\x3c/a\x3e\x3cbr\x3e\x3cbr\x3ePowered by \x3cimg src\x3d"images/src/meteorite_free.png" width\x3d"20px"\x3e \x3ca href\x3d"http://www.meteorite.bi/consulting/" target\x3d"_blank"\x3ewww.meteorite.bi\x3c/a\x3e',
...
a.workspace;_.bindAll(this,"call","reflect_properties","run_query","swap_axes_on_dropzones","display_drillthrough","clicked_cell_drillthrough_export","clicked_cell_drillacross","clicked_cell_drillthrough","activate_buttons","switch_to_mdx","post_mdx_transform","toggle_fields_action");this.workspace.bind("properties:loaded",this.reflect_properties);this.workspace.trigger("workspace:toolbar:render",{workspace:this.workspace});this.workspace.bind("query:new",this.activate_buttons);this.workspace.bind("query:result",
this.activate_buttons)},activate_buttons:function(a){null!==a&&a.data&&a.data.cellset&&0<a.data.cellset.length?($(a.workspace.toolbar.el).find(".button").removeClass("disabled_toolbar"),$(a.workspace.el).find("td.data").removeClass("cellhighlight").unbind("click"),$(a.workspace.el).find(".table_mode").removeClass("on")):($(a.workspace.toolbar.el).find(".button").addClass("disabled_toolbar").removeClass("on"),$(a.workspace.el).find(".fields_list .disabled_toolbar").removeClass("disabled_toolbar"),
...
b.workspace.sync_query();Saiku.ui.unblock();b.workspace.query.run()},data:{selections:JSON.stringify(e)}})}});$(this.workspace.el).find(".drillthrough, .drillthrough_export, .query_scenario, .drillacross").removeClass("on")}},query_scenario:function(a){$(a.target).toggleClass("on");this.check_modes($(a.target))},zoom_mode:function(a){$(a.target).toggleClass("on");this.check_modes($(a.target))},drillacross:function(a){$(a.target).toggleClass("on");this.check_modes($(a.target))},drillthrough:function(a){$(a.target).toggleClass("on");
...
void 0===g.level.annotations.SaikuDayFormatString||0!==m.selection.members.length?(new SelectionsModal({target:c,name:c.text(),key:k,workspace:this.workspace})).open():(new DateFilterModal({dimension:d,hierarchy:e,target:c,name:c.text(),data:g,analyzerDateFormat:g.level.annotations.AnalyzerDateFormat,dimHier:h,key:k,workspace:this.workspace})).open();return!1},measure_action:function(a){var b=this;if("undefined"==typeof this.workspace.query||"QUERYMODEL"!=this.workspace.query.model.type||"view"==
Settings.MODE)return!1;a=$(a.target).hasClass("limit")?$(a.target):$(a.target).parent();var c={HEADER:{name:"Position",disabled:!0,i18n:!0},sep1:"---------",BOTTOM_COLUMNS:{name:"Columns | Measures",i18n:!0},TOP_COLUMNS:{name:"Measures | Columns",i18n:!0},BOTTOM_ROWS:{name:"Rows | Measures",i18n:!0},TOP_ROWS:{name:"Measures | Rows",i18n:!0},sep2:"---------",reset:{name:"Reset Default",i18n:!0},cancel:{name:"Cancel",i18n:!0}};$.each(c,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});
$.contextMenu("destroy",".limit");$.contextMenu({appendTo:a,selector:".limit",ignoreRightClick:!0,build:function(a,e){var f=b.workspace.query;return{callback:function(a,b){var c=f.helper.model().queryModel.details;if("cancel"!==a){if("reset"===a)c.location=SaikuOlapQueryTemplate.queryModel.details.location,c.axis=SaikuOlapQueryTemplate.queryModel.details.axis;else{var d=a.split("_")[0],e=a.split("_")[1];c.location=d;c.axis=e}f.run()}},items:c}}});a.contextMenu()},limit_axis:function(a){var b=this;
if("undefined"==typeof this.workspace.query||"QUERYMODEL"!=this.workspace.query.model.type||"view"==Settings.MODE)return!1;var c=$(a.target).hasClass("limit")?$(a.target):$(a.target).parent(),d=c.siblings(".fields_list_body").parent().attr("title");$.contextMenu("destroy",".limit");$.contextMenu({appendTo:c,selector:".limit",ignoreRightClick:!0,build:function(a,f){var g={},h=Saiku.session.sessionworkspace.cube[b.workspace.selected_cube].get("data").measures,k=b.workspace.query.helper.getAxis(d),l,
m,n,s,q,t,u,z,w,B=!1,r=!1,D=!1;k&&k.filters&&_.each(k.filters,function(a){"N"==a.flavour&&(l=k["function"],m=a.expressions[0],n=a.expressions[1],D=!0);"Generic"==a.flavour&&(s=a.expressions[0],B=!0)});k&&k.sortOrder&&(q=k.sortOrder,t=k.sortEvaluationLiteral,r=!0);k&&k.aggregators&&0<k.aggregators.length&&(w=k.aggregators[0]);null!==l&&null===n?z=l+"###SEPARATOR###"+m:null!==l&&null!==n&&null!==m&&(z="custom");r&&null!==q&&(u="customsort");_.each(h,function(a){g[a.uniqueName]={name:a.caption,payload:{n:10,
sortliteral:a.uniqueName}}});_.each(k.hierarchies,function(a){for(var b in a.levels)console.log(b)});var y=function(a,b){var c={},d;for(d in a)c[b+"###SEPARATOR###"+d]=_.clone(a[d]),c[b+"###SEPARATOR###"+d].fun=b,b==l&&n==d&&a[d].payload.n==m&&(z=b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+"\x3c/b\x3e"),b==q&&t==d&&(u=b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+"\x3c/b\x3e");return c},y={filter:{name:"Filter",i18n:!0,items:{customfilter:{name:"Custom...",i18n:!0},
clearfilter:{name:"Clear Filter",i18n:!0}}},limit:{name:"Limit",i18n:!0,items:{"TopCount###SEPARATOR###10":{name:"Top 10",i18n:!0},"BottomCount###SEPARATOR###10":{name:"Bottom 10",i18n:!0},TopCountQuick:{name:"Top 10 by...",i18n:!0,items:y(g,"TopCount")},BottomCountQuick:{name:"Bottom 10 by...",i18n:!0,items:y(g,"BottomCount")},customtop:{name:"Custom Limit...",i18n:!0},clearlimit:{name:"Clear Limit",i18n:!0}}},sort:{name:"Sort",i18n:!0,items:{ASCQuick:{name:"Ascending",i18n:!0,items:y(g,"ASC")},
DESCQuick:{name:"Descending",i18n:!0,items:y(g,"DESC")},BASCQuick:{name:"Ascending (Breaking Hierarchy)",i18n:!0,items:y(g,"BASC")},BDESCQuick:{name:"Descending (Breaking Hierarchy)",i18n:!0,items:y(g,"BDESC")},customsort:{name:"Custom...",i18n:!0},clearsort:{name:"Clear Sort",i18n:!0}}},grand_totals:{name:"Grand totals",i18n:!0,items:{show_totals_not:{name:"None",i18n:!0},show_totals_sum:{name:"Sum",i18n:!0},show_totals_min:{name:"Min",i18n:!0},show_totals_max:{name:"Max",i18n:!0},show_totals_avg:{name:"Avg",
i18n:!0}}},cancel:{name:"Cancel",i18n:!0}};$.each(y,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});var v=y.grand_totals.items;if(w)for(var G in v)G.substring(12)==w&&(v[G].name="\x3cb\x3e"+v[G].name+"\x3c/b");else v.show_totals_not.name="\x3cb\x3e"+v.show_totals_not.name+"\x3c/b";g["10"]={payload:{n:10}};B&&(w=y.filter,w.name="\x3cb\x3e"+w.name+"\x3c/b\x3e",w.items.customfilter.name="\x3cb\x3e"+w.items.customfilter.name+"\x3c/b\x3e");r&&(r=y.sort.items,y.sort.name="\x3cb\x3e"+y.sort.name+
"\x3c/b\x3e",u in r&&(r[u].name="\x3cb\x3e"+r[u].name+"\x3c/b\x3e"));D&&(r=y.limit.items,y.limit.name="\x3cb\x3e"+y.limit.name+"\x3c/b\x3e",z in r&&(r[z].name="\x3cb\x3e"+r[z].name+"\x3c/b\x3e"));return{callback:function(a,e){var f;if("cancel"!=a)if("clearfilter"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(k,"Generic"),b.synchronize_query(),b.workspace.query.run();else if("customfilter"==a)f=function(a){var c=[];c.push(a);b.workspace.query.helper.removeFilter(k,"Generic");k.filters.push({flavour:"Generic",
operator:null,"function":"Filter",expressions:c});b.synchronize_query();b.workspace.query.run()},(new FilterModal({axis:d,success:f,query:b.workspace.query,expression:s,expressionType:"Filter"})).render().open();else if("clearlimit"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(k,"N"),b.synchronize_query(),b.workspace.query.run();else if("customtop"==a)f=function(a,c,d){var e=[];e.push(c);d&&e.push(d);b.workspace.query.helper.removeFilter(k,"N");k.filters.push({flavour:"N",operator:null,
"function":a,expressions:e});b.synchronize_query();b.workspace.query.run()},(new CustomFilterModal({axis:d,measures:h,success:f,query:b.workspace.query,func:l,n:m,sortliteral:n})).render().open();else if("customsort"==a)f=function(a,c){k.sortOrder=a;k.sortEvaluationLiteral=c;b.synchronize_query();b.workspace.query.run()},(new FilterModal({axis:d,success:f,query:b.workspace.query,expression:t,expressionType:"Order"})).render().open();else{if("clearsort"==a)k.sortOrder=null,k.sortEvaluationLiteral=
null,b.synchronize_query();else if(0===a.indexOf("show_totals_")){f=a.substring(12);var r=[];r.push(f);k.aggregators=r}else{f=a.split("###SEPARATOR###")[0];var w=a.split("###SEPARATOR###")[1];-1<_.indexOf(["ASC","BASC","DESC","BDESC"],f)?(k.sortOrder=f,k.sortEvaluationLiteral=g[w].payload.sortliteral):-1<_.indexOf(["Param"],f)?(console.log("here"),k.sortEvaluationLiteral=g[w].payload.sortliteral):(r=[],r.push(g[w].payload.n),(w=g[w].payload.sortliteral)&&r.push(w),b.workspace.query.helper.removeFilter(k,
"N"),k.filters.push({flavour:"N",operator:null,"function":f,expressions:r}));b.synchronize_query()}b.workspace.query.run()}},items:y}}});c.contextMenu()}}),Table=Backbone.View.extend({className:"table_wrapper",events:{"click th.row":"clicked_cell","click th.col":"clicked_cell"},initialize:function(a){this.workspace=a.workspace;this.renderer=new SaikuTableRenderer;_.bindAll(this,"render","process_data");this.workspace.bind("query:result",this.render);this.id=_.uniqueId("table_");$(this.el).attr("id",
this.id)},clicked_cell:function(a){var b=this;0<$(this.workspace.el).find(".workspace_results.ui-selectable").length&&$(this.workspace.el).find(".workspace_results").selectable("destroy");a=$(a.target).hasClass("row")||$(a.target).hasClass("col")?$(a.target).find("div"):$(a.target);$(document);$.contextMenu("destroy",".row, .col");$.contextMenu({appendTo:a,selector:".row, .col",ignoreRightClick:!0,build:function(a,d){var e=$(d.currentTarget).find("div"),f=$(d.currentTarget).hasClass("row")?"ROWS":
"COLUMNS",g=e.attr("rel").split(":"),h=parseInt(g[0]),g=parseInt(g[1]),k=b.workspace.query.result.lastresult().cellset[h][g],h=b.workspace.query;h.get("schema");h.get("connection");h.get("catalog");h.get("cube");var l=k.properties.dimension,m=k.properties.hierarchy,n=k.properties.level,s="",q=JSON.stringify({hierarchy:m,uniquename:n,type:"level",action:"delete"})+","+JSON.stringify({hierarchy:m,uniquename:k.properties.uniquename,type:"member",action:"add"}),h=k.properties.uniquename,t={},g=b.workspace.selected_cube,
u;Saiku.session.sessionworkspace.cube[g]&&u&&measures||("undefined"!==typeof localStorage&&localStorage&&null!==localStorage.getItem("cube."+g)?Saiku.session.sessionworkspace.cube[g]=new Cube(JSON.parse(localStorage.getItem("cube."+g))):(Saiku.session.sessionworkspace.cube[g]=new Cube({key:g}),Saiku.session.sessionworkspace.cube[g].fetch({async:!1})),u=Saiku.session.sessionworkspace.cube[g].get("data").dimensions);var z=[],g=b.workspace.query.helper.getHierarchy(m);_.each(g.levels,function(a){z.push(m+
".["+a.name+"]")});_.each(u,function(a){a.name==l&&_.each(a.hierarchies,function(a){a.uniqueName==m&&_.each(a.levels,function(a){t[a.name]={name:a.caption,payload:JSON.stringify({hierarchy:m,uniquename:a.uniqueName,type:"level",action:"add"})};-1<_.indexOf(z,a.uniqueName)&&(t[a.name].disabled=!0,t["remove-"+a.name]={name:a.caption,payload:JSON.stringify({hierarchy:m,uniquename:a.uniqueName,type:"level",action:"delete"})});a.uniqueName==n&&(s=a.caption,l_name=a.name);t["keep-"+a.name]=t[a.name];t["include-"+
a.name]=JSON.parse(JSON.stringify(t[a.name]));t["keep-"+a.name].payload=q+","+t[a.name].payload})})});t.keeponly={payload:q};t.getchildren={payload:h};t.hasOwnProperty("remove-"+l_name)&&t.hasOwnProperty("include-"+l_name)&&(t.showall={payload:t["remove-"+l_name].payload+", "+t["include-"+l_name].payload});u=function(a){var b={},c;for(c in t)null!==a&&a.length<c.length&&c.substr(0,a.length)==a&&(b[c]=t[c]);return b};h={name:{name:"\x3cb\x3e"+e.html()+"\x3c/b\x3e",disabled:!0},sep1:"---------",keeponly:{name:"Keep Only",
i18n:!0,payload:q}};"Measures"!=l&&(h.fold1key={name:"Include Level",i18n:!0,items:u("include-")},h.fold2key={name:"Keep and Include Level",i18n:!0,items:u("keep-")},h.fold3key={name:"Remove Level",i18n:!0,items:u("remove-")},h.filterlevel={name:"Filter Level",i18n:!0});$.each(h,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});return{callback:function(a,c){var d=[];if("keeponly"===a){var g=b.workspace.query.helper.getHierarchy(m);g&&g.levels.hasOwnProperty(s)&&(d.push({uniqueName:k.properties.uniquename,
caption:k.properties.uniquename}),g.levels[s].selection={type:"INCLUSION",members:d},b.workspace.drop_zones.synchronize_query(),b.workspace.query.run(!0))}else if("filterlevel"===a)d=k.properties.level.substring(k.properties.level.lastIndexOf(".")+1),d=d.replace("[","").replace("]",""),(new SelectionsModal({target:e,name:"Filter Level",key:k.properties.hierarchy+"/"+d,workspace:b.workspace,axis:"ROWS"})).open();else if("remove"===a.substring(0,a.indexOf("-"))){var h=a.substring(a.indexOf("-")+1);
b.workspace.query.helper.removeLevel(m,h);b.workspace.drop_zones.synchronize_query();b.workspace.query.run(!0)}else"keep"===a.substring(0,a.indexOf("-"))?(h=a.substring(a.indexOf("-")+1),(g=b.workspace.query.helper.getHierarchy(m))&&g.levels.hasOwnProperty(s)&&(d.push({uniqueName:k.properties.uniquename,caption:k.properties.uniquename}),g.levels[s].selection={type:"INCLUSION",members:d},b.workspace.query.helper.includeLevel(f,m,h,null),b.workspace.drop_zones.synchronize_query(),b.workspace.query.run(!0))):
"include"===a.substring(0,a.indexOf("-"))&&(h=a.substring(a.indexOf("-")+1),b.workspace.query.helper.includeLevel(f,m,h,null),b.workspace.drop_zones.synchronize_query(),b.workspace.query.run(!0))},items:h}}});a.contextMenu()},render:function(a,b){"undefined"==typeof a||"undefined"==typeof a.data||$(this.workspace.el).is(":visible")&&!$(this.el).is(":visible")||null!==a.data&&null!==a.data.error||null===a.data||a.data.height&&0===a.data.height||(this.clearOut(),$(this.el).html("Rendering "+a.data.width+
" columns and "+a.data.height+" rows..."),_.delay(this.process_data,2,a.data))},clearOut:function(){this.renderer.clear();$(this.workspace.el).find(".workspace_results").unbind("scroll");var a=document.getElementById(this.id);null==a&&(this.workspace.tab.select(),a=document.getElementById(this.id));var b=a.firstChild;b&&a.removeChild(b)},process_data:function(a){this.workspace.processing.hide();this.workspace.adjust();this.clearOut();$(this.el).html("\x3ctable\x3e\x3c/table\x3e");this.renderer.render(a,
...
this;try{var c=this.query.model.properties?this.query.model.properties:{},d="RENDER_MODE"in Settings?Settings.RENDER_MODE:"saiku.ui.render.mode"in c?c["saiku.ui.render.mode"]:null,e="RENDER_TYPE"in Settings?Settings.RENDER_TYPE:"saiku.ui.render.type"in c?c["saiku.ui.render.type"]:null;"table"==Settings.MODE?d="table":"chart"==Settings.MODE&&(d="chart");"undefined"!=typeof d&&null!==d&&this.querytoolbar.switch_render(d);"chart"==d?($(this.chart.el).find(".canvas_wrapper").hide(),this.chart.renderer.switch_chart(e),
$(this.querytoolbar.el).find('ul.chart [href\x3d"#'+e+'"]').parent().siblings().find(".on").removeClass("on"),$(this.querytoolbar.el).find('ul.chart [href\x3d"#'+e+'"]').addClass("on")):"table"==d&&e in this.querytoolbar&&(this.querytoolbar.render_mode="table",this.querytoolbar.spark_mode=e,$(this.querytoolbar.el).find("ul.table a."+e).addClass("on"))}catch(f){Saiku.error(this.cid,f)}"table"==Settings.MODE&&this.query?this.query.run(!0):("MDX"==this.query.model.type?(this.query.setProperty("saiku.olap.result.formatter",
...
"READ")&&$(this.el).find(".for_queries .run").parent().removeClass("hide");"undefined"!=typeof c.acl&&-1<_.indexOf(c.acl,"WRITE")&&($(this.el).find(".for_queries .delete").parent().removeClass("hide"),$(this.el).find(".for_queries .edit").parent().removeClass("hide"));"undefined"!=typeof c.acl&&-1<_.indexOf(c.acl,"GRANT")&&$(this.el).find(".for_queries .edit_permissions").parent().removeClass("hide");try{var d=a.split("/");if(1<d.length){var e=d.splice(0,d.length-1).join("/"),f=this.queries[e];"undefined"!=
typeof f.acl&&-1<_.indexOf(f.acl,"WRITE")&&$(this.el).find(".add_folder").parent().removeClass("hide")}else 1==d.length&&$(this.el).find(".add_folder").parent().removeClass("hide")}catch(g){}var d=$(this.el).find(".workspace_results").html("\x3ch3\x3e\x3cstrong\x3e"+c.name+"\x3c/strong\x3e\x3c/h3\x3e"),d=$('\x3cul id\x3d"query_info" /\x3e').appendTo(d),h;for(h in c)c.hasOwnProperty(h)&&"name"!=h&&d.append($("\x3cli /\x3e").html("\x3cstrong\x3e"+h+"\x3c/strong\x3e : "+c[h]));this.selected_query=new SavedQuery({file:a,
name:b,type:c.type});return!1},view_folder:function(a){var b=$(a.currentTarget).children("div").children("a");a=b.attr("href").replace("#","");var b=b.text(),c=this.queries[a];$(this.el).find(".workspace_toolbar").removeClass("hide");$(this.el).find(".add_folder").parent().addClass("hide");$(this.el).find(".for_queries").addClass("hide");$(this.el).find(".for_folder").addClass("hide");"undefined"!=typeof c.acl&&-1<_.indexOf(c.acl,"WRITE")&&($(this.el).find(".for_folder .delete").parent().removeClass("hide"),
...
typeof $selected&&$selected)if($selected.hasClass("folder_row"))a=$selected.children("a").attr("href"),a=1<a.length?a.substring(1,a.length):a,a+="/";else if($selected.hasClass("query")&&!$selected.parent().hasClass("RepositoryObjects")){var b=$selected.find("a");a=b.attr("href");b=b.text();a=a.substring(1,a.length-b.length)}(new AddFolderModal({path:a,success:this.clear_query})).render().open();return!1},click_canvas:function(a){$(a.currentTarget).hasClass("sidebar")&&$(this.el).find(".selected").removeClass("selected");
$(this.el).find(".add_folder").parent().removeClass("hide");return!1},toggle_folder:function(a){var b=$(a.currentTarget);this.unselect_current_selected();b.children(".folder_row").addClass("selected");var c=b.children(".folder_content");b.children(".folder_row").find(".sprite").hasClass("collapsed")?(b.children(".folder_row").find(".sprite").removeClass("collapsed"),c.removeClass("hide")):(b.children(".folder_row").find(".sprite").addClass("collapsed"),c.addClass("hide"));this.view_folder(a);return!1},
select_and_open_query:function(a){a=$(a.currentTarget).find("a");var b=a.attr("href").replace("#","");a.text();this.selected_query=new SavedQuery({file:b,name:b});this.open_query()},open_query:function(a){Saiku.ui.block("Opening query...");var b=this.queries[this.selected_query.get("file")],c=_.extend({file:this.selected_query.get("file"),formatter:Settings.CELLSET_FORMATTER},Settings.PARAMS),c=new Query(c,{name:this.selected_query.get("name")}),d=null;a&&!a.hasOwnProperty("currentTarget")&&(d=a);
Saiku.tabs.add(new Workspace({query:c,item:b,viewState:d}));return!1},open_contents:function(a){var b=[],c=this.queries[this.selected_query.get("file")];_.forEach(c.repoObjects,function(a){"FILE"===a.type&&b.push(a)});(new WarningModal({title:"Open Multiple Queries",message:"You are about to open "+b.length+" queries",okay:this.run_open_contents,okayobj:{files:b,viewstate:a}})).render().open();return!1},run_open_contents:function(a){_.forEach(a.files,function(b){Saiku.ui.block("Opening query...");
var c=_.extend({file:b.path,formatter:Settings.CELLSET_FORMATTER},Settings.PARAMS),c=new Query(c,{name:b.name}),d=null;a.viewstate&&!a.viewstate.hasOwnProperty("currentTarget")&&(d=viewstate);Saiku.tabs.add(new Workspace({query:c,item:b,viewState:d}))})},edit_query:function(){this.open_query("edit")},delete_repoObject:function(a){(new DeleteRepositoryObject({query:this.selected_query,success:this.clear_query})).render().open();return!1},move_repoObject:function(a){(new MoveRepositoryObject({query:this.selected_query,
success:this.clear_query})).render().open();return!1},edit_folder:function(a){alert("todo: edit folder properties/permissions");return!1},edit_permissions:function(a){(new PermissionsModal({workspace:this.workspace,title:"\x3cspan class\x3d'i18n'\x3ePermissions\x3c/span\x3e",file:this.selected_query.get("file")})).open()},clear_query:function(){$(this.el).find(".workspace_toolbar").addClass("hide");$(this.el).find(".workspace_results").html("");this.fetch_queries()},adjust:function(){$separator=$(this.el).find(".sidebar_separator");
$separator.height($("body").height()-87);$(this.el).find(".sidebar").css({width:300,height:$("body").height()-87});$(this.el).find(".workspace_inner").css({"margin-left":305});$(this.el).find(".workspace").css({"margin-left":-305});$(this.el).find(".workspace_results").css({width:$(document).width()-$(this.el).find(".sidebar").width()-30,height:$(document).height()-$("#header").height()-$(this.el).find(".workspace_toolbar").height()-$(this.el).find(".workspace_fields").height()-40})},toggle_sidebar:function(){$(this.el).find(".sidebar").toggleClass("hide");
var a=$(this.el).find(".sidebar").hasClass("hide")?5:265;$(this.el).find(".workspace_inner").css({"margin-left":a})},unselect_current_selected:function(){$(this.el).find(".selected").removeClass("selected")}}),SaveQuery=Modal.extend({type:"save",closeText:"Save",events:{click:"select_root_folder","click .dialog_footer a":"call","submit form":"save","click .query":"select_name","click li.folder":"toggle_folder","keyup .search_file":"search_file","click .cancel_search":"cancel_search"},buttons:[{text:"Save",
method:"save"},{text:"Cancel",method:"close"}],folder_name:null,file_name:null,initialize:function(a){var b=this,c="",d="";if(a.query.name){a.query.name=a.query.name.replace(/:/g,"/");var e=a.query.name.split("/"),d=a.query.name;this.file_name=c=e[e.length-1];1<e.length&&(this.folder_name=e.splice(0,e.length-1).join("/"))}this.query=a.query;this.message=_.template("\x3cform id\x3d'save_query_form'\x3e\x3clabel for\x3d'name' class\x3d'i18n'\x3eFile:\x3c/label\x3e\x26nbsp;\x3cinput type\x3d'text' name\x3d'name' value\x3d'\x3c%\x3d name %\x3e' /\x3e\x3cdiv class\x3d'RepositoryObjects'\x3e\x3cspan class\x3d'i18n'\x3eLoading...\x3c/span\x3e\x3c/div\x3e\x3cbr /\x3e\x3c/form\x3e\x3cdiv style\x3d\"height:25px; line-height:25px;\"\x3e\x3cb\x3e\x3cspan class\x3d\"i18n\"\x3eSearch:\x3c/span\x3e\x3c/b\x3e \x26nbsp; \x3cspan class\x3d\"search\"\x3e\x3cinput type\x3d\"text\" class\x3d\"search_file\"\x3e\x3c/input\x3e\x3cspan class\x3d\"cancel_search\"\x3e\x3c/span\x3e\x3c/span\x3e\x3c/div\x3e")({name:d});
...
"";return _.template(a)({})},setupPage:function(a){a=$(window).height();$("body").height(a);$(".stabs section").each(function(){$(this).height()});a=$("nav li.active a").attr("class");$("#"+a).fadeIn()},render:function(){var a=this,b=new License;Settings.BIPLUGIN5?b.fetch_license("api/api/license",function(b){$(a.el).html(a.template());"error"!==b.status&&"trial"!=b.data.get("licenseType")&&$(".enterprisetoggle").css("visibility","hidden");a.getContent();a.getNews();a.setupPage(a);$("nav li a").click(function(){var a=
$(this).attr("class");$("nav li").removeClass("active");$(this).parent().addClass("active");$(".stabs section").hide();$("#"+a).fadeIn()})}):b.fetch_license("api/license/",function(b){$(a.el).html(a.template());"error"!==b.status&&"trial"!=b.data.get("licenseType")&&$(".enterprisetoggle").css("visibility","hidden");a.getContent();a.getNews();a.setupPage(a);$("nav li a").click(function(){var a=$(this).attr("class");$("nav li").removeClass("active");$(this).parent().addClass("active");$(".stabs section").hide();
$("#"+a).fadeIn()})});return this},remove:function(){$(this.el).remove()},caption:function(a){return"Home"},getNews:function(){var a=this;$.ajax({type:"GET",url:"http://meteorite.bi/news.json",async:!1,contentType:"application/json",dataType:"jsonp",jsonpCallback:"jsonCallback",success:function(b){for(var c=0;c<b.item.length;c++)$(a.el).find("#news").append("\x3ch4 style\x3d'margin-left: 0.5%;color:#6D6E71;'\x3e"+b.item[c].title+"\x3c/h4\x3e\x3cstrong style\x3d'margin-left: 0.5%;color:#6D6E71;'\x3e"+
b.item[c].date+"\x3c/strong\x3e\x3cbr/\x3e\x3cp style\x3d'color:#6D6E71;'\x3e"+b.item[c].body+"\x3c/p\x3e")},error:function(a){console.log(a.message)}})},getContent:function(){var a=this,b=new License;$.ajax({type:"GET",url:"http://meteorite.bi/content.json",async:!1,contentType:"application/json",dataType:"jsonp",jsonpCallback:"jsonCallback2",cache:!0,success:function(c){$(a.el).find("#dyn_content").html(c.item[0].content);$(a.el).find(".responsive-container").fitVids();b.fetch_license("api/license/",
function(a){$(self.el).html(self.template());"error"!==a.status&&"trial"!=a.data.get("licenseType")&&$(".enterprisetoggle").css("visibility","hidden")})},error:function(a){b.fetch_license("api/license/",function(a){$(self.el).html(self.template());"error"!==a.status&&"trial"!=a.data.get("licenseType")&&$(".enterprisetoggle").css("visibility","hidden")})}})}}),SessionWorkspace=Backbone.Model.extend({initialize:function(a,b){_.extend(this,Backbone.Events);_.bindAll(this,"process_datasources","prefetch_dimensions");
this.initialized=!1;this.first=!0;"undefined"!==typeof localStorage&&localStorage&&(Settings.LOCALSTORAGE_EXPIRATION&&0!==Settings.LOCALSTORAGE_EXPIRATION||localStorage.clear(),localStorage.getItem("expiration")&&localStorage.getItem("expiration")<=(new Date).getTime()?localStorage.clear():localStorage.getItem("saiku-version")&&localStorage.getItem("saiku-version")===Settings.VERSION||(localStorage.clear(),localStorage.setItem("saiku-version",Settings.VERSION)));Saiku.ui.block("Loading datasources....");
this.fetch({success:this.process_datasources},{})},refresh:function(){"undefined"!==typeof localStorage&&localStorage&&localStorage.clear();this.clear();"undefined"!==typeof localStorage&&localStorage&&localStorage.setItem("saiku-version",Settings.VERSION);this.fetch({success:this.process_datasources},{})},destroy:function(){"undefined"!==typeof localStorage&&localStorage&&localStorage.clear();return!1},process_datasources:function(a,b){if("undefined"!==typeof localStorage&&localStorage&&null===localStorage.getItem("session")){localStorage.setItem("session",
JSON.stringify(b));var c=(new Date).getTime()+Settings.LOCALSTORAGE_EXPIRATION;"undefined"!==typeof localStorage&&localStorage&&localStorage.setItem("expiration",c)}this.cube_navigation=_.template($("#template-cubes").html())({connections:b});this.cube={};this.connections=b;_.delay(this.prefetch_dimensions,20);if(this.initialized)Settings.INITIAL_QUERY||Saiku.tabs.add(new Workspace);else{$(Saiku.toolbar.el).prependTo($("#header"));$("#header").show();Saiku.ui.unblock();Saiku.tabs.render();Saiku.events.trigger("session:new",
{session:this});c=Saiku.URLParams.paramsURI();if(!_.has(c,"splash"))c.splash=!0;else if(_.has(c,"splash")&&c.splash||_.has(c,"splash")&&null===c.splash)c.splash=!0;!Settings.INITIAL_QUERY&&c.splash?Saiku.tabs.add(new SplashScreen):Settings.INITIAL_QUERY||Saiku.tabs.add(new Workspace)}},prefetch_dimensions:function(){for(var a=0,b=this.connections.length;a<b;a++)for(var c=this.connections[a],d=0,e=c.catalogs.length;d<e;d++)for(var f=c.catalogs[d],g=0,h=f.schemas.length;g<h;g++)for(var k=f.schemas[g],
l=0,m=k.cubes.length;l<m;l++){var n=c.name+"/"+f.name+"/"+(""===k.name||null===k.name?"null":k.name)+"/"+encodeURIComponent(k.cubes[l].name);"undefined"!==typeof localStorage&&localStorage&&null!==localStorage.getItem("cube."+n)?this.cube[n]=new Cube(JSON.parse(localStorage.getItem("cube."+n))):(this.cube[n]=new Cube({key:n}),!0===Settings.DIMENSION_PREFETCH&&this.cube[n].fetch())}!this.initialized&&Backbone.history&&(Backbone.history.start(),this.initialized=!0)},url:function(){return this.first?
(this.first=!1,encodeURI(Saiku.session.username+"/discover")):encodeURI(Saiku.session.username+"/discover/refresh")}}),Member=Backbone.Model.extend({initialize:function(a,b){this.cube=b.cube;var c=b.dimension.split("/");this.hierarchy=decodeURIComponent(c[0]);this.level=decodeURIComponent(c[1])},url:function(){return encodeURI(Saiku.session.username+"/discover/")+this.cube+"/hierarchies/"+encodeURIComponent(this.hierarchy)+"/levels/"+encodeURIComponent(this.level)}}),Plugin=Backbone.Model.extend({}),
PluginCollection=Backbone.Collection.extend({model:Plugin,url:"info"}),SettingsOverride=Backbone.Model.extend({}),SettingsOverrideCollection=Backbone.Collection.extend({model:SettingsOverride,url:"info/ui-settings"}),License=Backbone.Model.extend({url:"api/license",initialize:function(){_.bindAll(this,"fetch_license")},fetch_license:function(a,b){this.fetch({success:function(a){b&&"function"===typeof b&&b({status:"success",data:a})},error:function(a){b&&"function"===typeof b&&b({status:"error",data:a})}})}}),
